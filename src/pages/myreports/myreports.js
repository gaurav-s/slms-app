...
var MyreportsPage = /** @class */ (function () {
    function MyreportsPage(navCtrl, loadingCtrl, navParams, userData, webServices, helper) {
    ...
    MyreportsPage.prototype.getRectified = function () {
        var _this = this;
        var data = {};
    ...
    MyreportsPage.prototype.getComplaintData = function () {
        var _this = this;
        var data = {
    ...
    MyreportsPage.prototype.newComplaint = function () {
